...
Paketnya membawa akselerator native untuk `win-x64`, `win-arm64`, `linux-x64`, `linux-arm64`, `osx-x64`, dan `osx-arm64`. Di platform lain akselerator itu memang tidak ada, dan CuteDB memakai pemindai terkelola.
